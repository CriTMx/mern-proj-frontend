...
function AllSongs_Instance({ songId, songImg, songTitle, songSubtitle, playNewSong }) {
  return (
    <div className='song-instance text-center me-sm-3 mb-4' id='songInstance'>
      ...
      <Button className='song-play-btn' onClick={() => { playNewSong(songId); }}>
        <span className='material-symbols-outlined symbol-filled'>play_circle</span>
      </Button>
    </div>
  )
}
